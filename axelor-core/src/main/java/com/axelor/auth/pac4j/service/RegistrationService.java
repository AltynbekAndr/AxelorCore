...
public class RegistrationService {
    ...
    public Connection getConnection(){
        ...
        public int createEmployee(
            String dateOfBirth,String phoneType,String phoneType2,String names,
            String сitizenships,String town,String country,String area,
            String passport,String documentExpirationDate,String documentIssueDate,String issuningAuthority,Connection connectionP){

        int id = getLastEmployeeId(connectionP)+1;
        String sqlInsert = "INSERT INTO hr_employee ( "+
                ...
                " contact_partner) "+
                "values( "+
                id+",4,current_timestamp,to_date('"+dateOfBirth+"','yyyy-mm-dd'),true,'"+phoneType+"',0,false,0, "+
                "2,'"+phoneType2+"','"+names+"',5,'days',1,false,0,1,"+сitizenships+","+town+","+country+","+area+", "+
                "1,1,1,'"+passport+"',to_date('"+documentExpirationDate+"','yyyy-mm-dd'),to_date('"+documentIssueDate+"','yyyy-mm-dd'),'"+issuningAuthority+"',1) ";
        if(connectionP!=null){
    ...
    public void createUser(String password,
        ...
        String insertSQl = "INSERT INTO AUTH_USER(id,activate_on,expires_on,code,group_id,name,password,blocked,force_password_change,is_include_sub_context_projects," +
                ...
                "VALUES ("+id+",current_timestamp, to_date('01.01.2035', 'dd.mm.yyyy' ), '"+login+"', 4,'"+username+"','"+password+"',false,false,false,false,false," +
                "'ru',false,true,true,false,false,false,false,current_timestamp,'"+email+"',4,'"+username+"',5,"+employee_id+")";
